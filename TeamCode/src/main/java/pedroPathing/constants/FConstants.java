...
public class FConstants {
    static {
        ...
        FollowerConstants.mass = 13.65942;

        FollowerConstants.xMovement = 94.07;
        FollowerConstants.yMovement = 71.9;

        FollowerConstants.forwardZeroPowerAcceleration = -51.42;
        FollowerConstants.lateralZeroPowerAcceleration = -107.26;
