...
public class HardwareConstants {
    ...
    public static DcMotorSimple.Direction extensionMotorDir = REVERSE;
    public static String extEnc = "EM";
    public static String liftMotor1 = "LM1";
    public static String liftMotor1Enc = "LM1";
    public static DcMotorSimple.Direction liftMotor1Dir = FORWARD;
    public static String liftMotor2 = "LM2";
    public static String liftMotor2Enc = "LM1";
    public static DcMotorSimple.Direction liftMotor2Dir = REVERSE;
    ...
    public static double iServo1Retracted = 0.1;
    public static double iServo1Extended= 0.9;
    public static String iServo2 = "IS2";
    public static double iServo2Retracted = 0.1;
    public static double iServo2Extended= 0.9;
    public static String arm1 = "ARM1";
    public static double arm1Extended = 1;
    public static double arm1Retracted = 0.3;
    public static String arm2 = "ARM2";
    public static double arm2Extended = 1;
    public static double arm2Retracted = 0.3;
